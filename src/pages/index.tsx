...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`expediture traker `}</title>

        <meta
          name="description"
          content="Welcome to Expediture Traker, your reliable partner in managing and tracking your personal expenditure with ease and precision."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Expediture Traker, your reliable partner in managing and tracking your personal expenditure with ease and precision.`}
            </Text>
            <Box
