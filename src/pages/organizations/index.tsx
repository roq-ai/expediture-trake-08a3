...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'expenditure.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('expenditure', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'expenditure',
          header: 'Expenditure',
          accessorKey: 'expenditure',
          cell: ({ row: { original: record } }: any) => record?._count?.expenditure,
        }
      : null,
